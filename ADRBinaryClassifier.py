...
if __name__ == '__main__':
    ...
    data_set_filename = 'C:\\Users\\home1\\Desktop\\project\\adr_classify_twitter_data_downloaded.txt'
    ...
    print(training_data)
    training_data['structuralfeatures'] = FeatureExtractionUtilities.getstructuralfeatures(
    ...
    print(training_data)
    training_data['topictexts'], training_data['topics'] = FeatureExtractionUtilities.gettopicscores(
        training_data['text'])
    print(training_data)
    ...
    vectorizer = CountVectorizer(ngram_range=(1, 3), analyzer="word", tokenizer=None, preprocessor=None,
                                 max_features=5000)
    synsetvectorizer = CountVectorizer(ngram_range=(1, 1), analyzer="word", tokenizer=None, preprocessor=None,
                                       max_features=2000)
    clustervectorizer = CountVectorizer(ngram_range=(1, 1), analyzer="word", tokenizer=None, preprocessor=None,
                                        max_features=1000)
    topicvectorizer = CountVectorizer(ngram_range=(1, 1), analyzer="word", tokenizer=None, preprocessor=None,
                                      max_features=500)
    ...
    testing_data['structuralfeatures'] = FeatureExtractionUtilities.getstructuralfeatures(
        testing_data['unstemmed_text'])
    ...
    test_data_vectors = np.concatenate((test_data_vectors, testing_data['goodbad']), axis=1)
     ...
     #COONDITIONAL RANDOM FIELD CLASSIFIER
